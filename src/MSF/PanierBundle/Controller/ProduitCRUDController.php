...
{
    public function CRUDAction($name)
    {
    ...
    {
        $em = $this->getDoctrine()->getManager()->getRepository('EcommerceBundle:Produit');
    ...
    public function panierAction(){
        ...
        return $this->render('PanierBundle:Default:panier.html.twig',
            array(
