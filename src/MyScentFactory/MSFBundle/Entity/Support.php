 ...
 * @ORM\Entity(repositoryClass="MSFBundle\Repository\SupportRepository")
 */
class Support
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MSFBundle\Entity\Composition", inversedBy="$id_support")
     */
     ...
     * @ORM\ManyToMany(targetEntity="MSFBundle\Entity\Produit")
     */
    private $id_produit;
     ...
     * Set idComposition.
     *
     * @param \MSFBundle\Entity\Composition|null $idComposition
     *
     * @return Support
     */
    public function setIdComposition(\MSFBundle\Entity\Composition $idComposition = null)
    {
     ...
     * Get idComposition.
     *
     * @return \MSFBundle\Entity\Composition|null
     */
