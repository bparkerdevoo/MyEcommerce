...
if ($lazyLoad) {
    return $this->services['doctrine.orm.default_entity_manager'] = $this->createProxy('EntityManager_85fb73c', function () {
        return \EntityManager_85fb73c::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/MyScentFactory/UserBundle/Entity'), 2 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Entity'), 3 => ($this->targetDirs[3].'/src/MyScentFactory/MSFBundle/Entity')));

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver($b, 'AppBundle\\Entity');
$c->addDriver($b, 'MyScentFactory\\UserBundle\\Entity');
$c->addDriver($b, 'Vich\\UploaderBundle\\Entity');
$c->addDriver($b, 'MyScentFactory\\MSFBundle\\Entity');
...
$d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'UserBundle' => 'MyScentFactory\\UserBundle\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity', 'MSFBundle' => 'MyScentFactory\\MSFBundle\\Entity'));
