...
return $this->services['knp_menu.menu_provider.lazy'] = new \Knp\Menu\Provider\LazyProvider(array('sonata_admin_sidebar' => function () {
    return ${($_ = isset($this->services['sonata.admin.sidebar_menu']) ? $this->services['sonata.admin.sidebar_menu'] : $this->load(__DIR__.'/getSonata_Admin_SidebarMenuService.php')) && false ?: '_'};
}));
