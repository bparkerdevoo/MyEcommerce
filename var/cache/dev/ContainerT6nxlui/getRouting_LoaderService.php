...
$e->addLoader(${($_ = isset($this->services['sonata.admin.route_loader']) ? $this->services['sonata.admin.route_loader'] : $this->load(__DIR__.'/getSonata_Admin_RouteLoaderService.php')) && false ?: '_'});
$e->addLoader($d);
